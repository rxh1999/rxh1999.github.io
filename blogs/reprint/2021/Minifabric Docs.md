...
categories: 
 - reprint
---
[From](https://github.com/hyperledger-labs/minifabric/blob/main/docs/README.md)
...
========================
- [Minifabric](#minifabric)
- [The table of the content](#the-table-of-the-content)
    - [Prerequisites](#prerequisites)
    - [Get the script and make it available system wide](#get-the-script-and-make-it-available-system-wide)
        - [Run the following command for Linux or OS X](#run-the-following-command-for-linux-or-os-x)
        - [Run the following command for windows 10](#run-the-following-command-for-windows-10)
        - [Make minifab available system wide](#make-minifab-available-system-wide)
    - [Working directory](#working-directory)
    - [Stand up a Fabric network:](#stand-up-a-fabric-network)
    - [Tear down the Fabric network:](#tear-down-the-fabric-network)
    - [The normal process of working with Hyperledger Fabric](#the-normal-process-of-working-with-hyperledger-fabric)
    - [Setup a network using a different spec](#setup-a-network-using-a-different-spec)
    - [Install your own chaincode](#install-your-own-chaincode)
    - [Upgrade your chaincode](#upgrade-your-chaincode)
    - [Instantiate/Initialize newly installed/upgraded chaincode](#instantiateinitialize-newly-installedupgraded-chaincode)
    - [Invoke chaincode methods](#invoke-chaincode-methods)
    - [Query blocks](#query-blocks)
    - [Update the channel configuration](#update-the-channel-configuration)
    - [Add a new organization to your Fabric network](#add-a-new-organization-to-your-fabric-network)
    - [Check node health and metrics](#check-node-health-and-metrics)
    - [Execution context](#execution-context)
    - [Working with customised chaincode builders](#working-with-customised-chaincode-builders)
    - [Update minifabric](#update-minifabric)
    - [See more available Minifabric commands](#see-more-available-minifabric-commands)
    - [For the people who has trouble to download images from docker hub](#for-the-people-who-has-trouble-to-download-images-from-docker-hub)
        - [Fabric 2.0](#fabric-20)
        - [Fabric 1.4 which is an alias to 1.4.6](#fabric-14-which-is-an-alias-to-146)
    - [Minifabric videos](#minifabric-videos)
    - [Build minifabric locally](#build-minifabric-locally)
    - [Hook up Explorer to your Fabric network](#hook-up-explorer-to-your-fabric-network)
    - [Run your application quickly](#run-your-application-quickly)
    - [Run Caliper test](#run-caliper-test)
    - [Start up portainer web ui](#start-up-portainer-web-ui)
